...
- (NSDictionary*) initializeFemaleDictionary
{
    return @{@"cha1" : [self initializeBodySpines:-20 withY:40 withZ:60 andScreen:@"cha1"],
             ...
             @"hairstyle1" : makeSettings(@"hair1", @"hairstyle1", hair, 179.0f, 90.0f, 68.0f),
             @"hairstyle2" : makeSettings(@"hair2", @"hairstyle2", hair, 179.0f, 90.0f, 68.0f),
             @"hairstyle3" : makeSettings(@"hair3", @"hairstyle3", hair, 179.0f, 90.0f, 68.0f),
             @"hairstyle4" : makeSettings(@"hair4", @"hairstyle4", hair, 179.0f, 90.0f, 68.0f),
             ...
             @"shirt5" : makeSettings(@"shirt_short", @"shirt5", top, 127.0f, 0.0f, 0.0f),
             @"shirt6" : makeSettings(@"shirt_short", @"shirt6", top, 38.0f, 127.0f, 0.0f),
             @"shirt7" : makeSettings(@"shirt_short", @"shirt7", top, 0.0f, 148.0f, 255.0f),
             @"shirt8" : makeSettings(@"shirt_short", @"shirt8", top, 255.0f, 106.0f, 0.0f),
    
             @"shirt9" : makeSettings(@"shirt_middle", @"shirt9", top, 127.0f, 0.0f, 0.0f),
             @"shirt10": makeSettings(@"shirt_middle", @"shirt10", top, 38.0f, 127.0f, 0.0f),
             @"shirt11": makeSettings(@"shirt_middle", @"shirt11", top, 0.0f, 148.0f, 255.0f),
             @"shirt12": makeSettings(@"shirt_middle", @"shirt12", top, 157.0f, 141.0f, 110.0f),
             @"shirt13" : makeSettings(@"shirt_long", @"shirt13", top, 127.0f, 0.0f, 0.0f),
             @"shirt14" : makeSettings(@"shirt_long", @"shirt14", top, 0.0f, 157.0f, 0.0f),
             @"shirt15" : makeSettings(@"shirt_long", @"shirt15", top, 86.0f, 64.0f, 42.0f),
             @"shirt16" : makeSettings(@"shirt_long", @"shirt16", top, 255.0f, 105.0f, 0.0f),
