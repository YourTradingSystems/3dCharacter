...
- (NSDictionary*) initializeMaleDictionary
{
    return @{@"cha1" : [self initializeBodySpines:-20 withY:40 withZ:60 andScreen:@"cha1"],
             ...
             @"glasses1" : makeSettings(@"none", @"glasses1", glasses, 250.0f, 250.0f, 250.0f),
             @"glasses2" : makeSettings(@"glasses1_male", @"glasses2", glasses, 60.0f, 10.0f, 20.0f),
             @"glasses3" : makeSettings(@"glasses1_male", @"glasses3", glasses, 20.0f, 10.0f, 5.0f),
             @"glasses4" : makeSettings(@"glasses1_male", @"glasses4", glasses, 70.0f, 65.0f, 65.0f),
             @"glasses5" : makeSettings(@"glasses1_male", @"glasses5", glasses, 80.0f, 0.0f, 20.0f),
             @"glasses6" : makeSettings(@"glasses1_male", @"glasses6", glasses, 15.0f, 0.0f, 50.0f),
             @"glasses7" : makeSettings(@"glasses1_male", @"glasses7", glasses, 130.0f, 65.0f, 10.0f),
             @"glasses8" : makeSettings(@"glasses1_male", @"glasses8", glasses, 60.0f, 10.0f, 20.0f),
             @"glasses9" : makeSettings(@"glasses1_male", @"glasses9", glasses, 25.0f, 15.0f, 5.0f),
             @"glasses10" : makeSettings(@"glasses1_male", @"glasses10", glasses, 70.0f, 65.0f, 65.0f),
             @"glasses11" : makeSettings(@"glasses1_male", @"glasses11", glasses, 80.0f, 0.0f, 20.0f),
             @"glasses12" : makeSettings(@"glasses1_male", @"glasses12", glasses, 15.0f, 0.0f, 50.0f),
             ...
             @"shirt1" : makeSettings(@"shirt_long2_male", @"shirt1_male", top, 255.0f, 255.0f, 255.0f),
             @"shirt2" : makeSettings(@"shirt_long2_male", @"shirt2_male", top, 160.0f, 160.0f, 160.0f),
             @"shirt3" : makeSettings(@"shirt_long2_male", @"shirt3_male", top, 160.0f, 0.0f, 40.0f),
             @"shirt4" : makeSettings(@"shirt_long2_male", @"shirt4_male", top, 180.0f, 100.0f, 100.0f),
             @"shirt5" : makeSettings(@"shirt_long2_male", @"shirt5_male", top, 40.0f, 150.0f, 20.0f),
             @"shirt6" : makeSettings(@"shirt_long2_male", @"shirt6_male", top, 130.0f, 130.0f, 80.0f),
             @"shirt7" : makeSettings(@"shirt_long2_male", @"shirt7_male", top, 255.0f, 255.0f, 255.0f),
             ...
             @"shoes1" : makeSettings(@"shoes1_male", @"shoes1", shoes, 210.0f, 190.0f, 160.0f),
             @"shoes2" : makeSettings(@"shoes1_male", @"shoes2", shoes, 180.0f, 140.0f, 105.0f),
             @"shoes3" : makeSettings(@"shoes1_male", @"shoes3", shoes, 210.0f, 135.0f, 155.0f),
             @"shoes4" : makeSettings(@"shoes1_male", @"shoes4", shoes, 155.0f, 140.0f, 110.0f),
             @"shoes5" : makeSettings(@"shoes1_male", @"shoes5", shoes, 85.0f, 65.0f, 40.0f),
             @"shoes6" : makeSettings(@"shoes1_male", @"shoes6", shoes, 40.0f, 45.0f, 20.0f),
             @"shoes7" : makeSettings(@"shoes1_male", @"shoes7", shoes, 210.0f, 190.0f, 160.0f),
             @"shoes8" : makeSettings(@"shoes1_male", @"shoes8", shoes, 180.0f, 140.0f, 105.0f),
             @"shoes9" : makeSettings(@"shoes1_male", @"shoes9", shoes, 210.0f, 135.0f, 155.0f),
             @"shoes10" : makeSettings(@"shoes1_male", @"shoes10", shoes, 155.0f, 140.0f, 110.0f),
             @"shoes11" : makeSettings(@"shoes1_male", @"shoes11", shoes, 85.0f, 65.0f, 40.0f),
             @"shoes12" : makeSettings(@"shoes1_male", @"shoes12", shoes, 40.0f, 45.0f, 20.0f),
