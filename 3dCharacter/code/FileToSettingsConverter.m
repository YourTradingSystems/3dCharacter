...
- (NSDictionary*) initializeMaleDictionary
{
    return @{@"cha1" : [self initializeBodySpines:-20 withY:40 withZ:60 andScreen:@"cha1"],
             ...
             @"glasses1" : makeSettings(@"none", @"glasses1", glasses, 200.0f, 50.0f, 50.0f),
             @"glasses2" : makeSettingsWithAlpha(@"glasses1_male", @"glasses2", glasses, 63.0f, 3.0f, 19.0f, 60.0f),
             @"glasses3" : makeSettingsWithAlpha(@"glasses1_male", @"glasses3", glasses, 29.0f, 18.0f, 11.0f, 60.0f),
             @"glasses4" : makeSettingsWithAlpha(@"glasses1_male", @"glasses4", glasses, 74.0f, 65.0f, 66.0f, 60.0f),
             @"glasses5" : makeSettingsWithAlpha(@"glasses1_male", @"glasses5", glasses, 129.0f, 74.0f, 83.0f, 60.0f),
             @"glasses6" : makeSettingsWithAlpha(@"glasses1_male", @"glasses6", glasses, 14.0f, 0.0f, 46.0f, 60.0f),
             @"glasses7" : makeSettingsWithAlpha(@"glasses1_male", @"glasses7", glasses, 122.0f, 58.0f, 12.0f, 60.0f),
             @"glasses8" : makeSettingsWithAlpha(@"glasses1_male", @"glasses8", glasses, 63.0f, 3.0f, 19.0f, 60.0f),
             @"glasses9" : makeSettingsWithAlpha(@"glasses1_male", @"glasses9", glasses, 24.0f, 13.0f, 8.0f, 60.0f),
             
             @"hairstyle1" : makeSettings(@"hair1_male", @"hairstyle1_male", hair, 200.0f, 100.0f, 0.0f),
             @"hairstyle2" : makeSettings(@"hair2_male", @"hairstyle2_male", hair, 127.0f, 51.0f, 0.0f),
